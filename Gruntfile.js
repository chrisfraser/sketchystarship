module.exports = function(grunt) {
    grunt.initConfig({
        ...
        "concat": {
            phaser: {
                files: {
                    'build/js/lib/phaser/phaser.js': ['bower_components/phaser/build/phaser.js'],
                    'build/js/lib/phaser/phaser.map': ['bower_components/phaser/build/phaser.map']
                }
            },
            requirejs: {
                files: {
        ...
        "requirejs": {
            compile: {
                options: {
                    ...
                    fileExclusionRegExp: /\.(png|jpg)$/ // ignore assets directory, imagemin will handle this instead
                }
            }
        },
        "imagemin": {
